...
public class EditLead {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.name("description")).sendKeys("Description will be cleared ");
		...
		driver.findElement(By.name("importantNote")).sendKeys("Entering important note here");
		driver.findElement(By.className("smallSubmit")).click();
		
		String titleofEditLead= driver.getTitle();
		System.out.println("The title of Edit Lead is:: "+ titleofEditLead);
		driver.close();

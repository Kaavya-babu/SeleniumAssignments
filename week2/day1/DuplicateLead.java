...
WebDriverManager.chromedriver().setup();
		...
		driver.findElement(By.id("createLeadForm_firstNameLocal")).sendKeys("Kaavyadharshu");
		driver.findElement(By.name("departmentName")).sendKeys("QA");
		driver.findElement(By.name("description")).sendKeys("DEscription is added ");
		...
		String titleofEditLead= driver.getTitle();
		System.out.println("The title is:: "+ titleofEditLead);
		
		driver.findElement(By.linkText("Duplicate Lead")).click();
		driver.findElement(By.id("createLeadForm_firstName")).clear();
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("New Kaavya");
		driver.findElement(By.className("smallSubmit")).click();
		String titleofDuplicateLead= driver.getTitle();
		System.out.println("The title of Duplicate Lead is:: "+ titleofDuplicateLead);
